...
$qry = "SELECT COUNT(PRODUCT_ID) AS NUMBER_OF_ROWS FROM PRODUCTS WHERE TRADER_REG_ID=$tid";
$send= oci_parse($conn, $qry);
oci_define_by_name($send, 'NUMBER_OF_ROWS', $number_of_rows);
oci_execute($send);
oci_fetch($send);
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="dashboardTrader.php" class="nav-link active">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
