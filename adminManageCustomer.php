...
$qry = !empty($search) ? $qry . " WHERE lower(CUSTOMER_FNAME) LIKE lower('$search%')" : $qry;

$send = oci_parse($conn, $qry);
oci_execute($send);
oci_fetch_all($send, $customers, null, null, OCI_FETCHSTATEMENT_BY_ROW);
            ...
            <section class="content">
                ...
                <table class="table table-striped table-dark">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?= $customer['CUSTOMER_REG_ID'] ?></td>
                                ...
                                <td><a href="amendCustomer.php?id=<?= $customer['CUSTOMER_REG_ID'] ?>">Update</a><br><a href="deleteCustomer.php?id=<?= $customer['CUSTOMER_REG_ID'] ?>" style="color: red">Delete</a></td>
