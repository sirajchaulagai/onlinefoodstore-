...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        $qry = "UPDATE SHOP SET SHOP_NAME = '$shopname' WHERE SHOP_ID = '$sid' ";
        ...
        if (!$result) {
            ...
            $message = ['message' => "Shop updated successfully", 'color' => "success"];
        }
...
$qry = "SELECT * FROM SHOP WHERE SHOP_ID='$sid' ";
$send = oci_parse($conn, $qry);
oci_execute($send);
$shop = oci_fetch_assoc($send);
            ...
            <section class="content">
                <form method="POST" action="">
                    ...
                    <div class="form-group col">
                        <input type="hidden" name="sid" id="id" value="<?= $shop['SHOP_ID'] ?>">
                        <label for="Name" class="col col-form-label">Shop Name : </label>
                        <div class="col-sm-6">
                            <input type="text" name="shopname" class="form-control" id="shopname" value="<?= $shop['SHOP_NAME'] ?>" required>
                        </div>
                    ...
                    <div class="form-group col">
                        <div class="col-sm-6">
                            <button type="submit" name="submit" class="btn btn-warning">Update Shop</button>
                        </div>
                    </div>
                </form> 
            </section>
